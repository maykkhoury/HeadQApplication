...
Public Class carsDeleteSync

    Public actionType As String = ""
    Private Sub carsSync_Load(sender As Object, e As EventArgs) Handles Me.Load
        loadCars()
    End Sub
    ...
    Private Sub butSearchCarForm_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles butSearchCarForm.Click
        ...
        Dim carFiltered() As Car = getDeletedCarsBySyncVersion(currentLastSyncVersion, whereStr)
    ...
    Private Sub butAddToSync_Click(sender As Object, e As EventArgs) Handles butAddToSync.Click
        ...
        For Each item In lsvCars.SelectedItems
            ...
            Dim newEntry As Boolean = Not syncCarsToDelete.ContainsKey(idCar)

            If newEntry Then
                Dim theCar As Car = getDeletedCarsBySyncVersion(currentLastSyncVersion, " AND idTable =" & idCar)(0)
                theCar.actionType = "delete"
                syncCarsToDelete.Add(idCar, theCar)
            End If
    ...
    Private Sub listSelectedCar()
        lsvCars.BackColor = System.Drawing.Color.FromArgb(255, 128, 128)
        If syncCarsToDelete.Count > 0 Then
            Dim carsSelected As Car()
            Dim MyArray As New ArrayList(syncCarsToDelete.Values)
