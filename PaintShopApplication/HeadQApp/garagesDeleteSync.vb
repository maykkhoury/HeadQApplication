...
Public Class garagesDeleteSync
    ...
    Private Sub butSearchGarageForm_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles butSearchGarageForm.Click
        ...
        If username.Trim <> "" Then
            If usernameChk Then
                str5 = str5 & " [username] like '%" & username & "%'"
            Else
                str5 = str5 & " [username] = '" & username & "'"
            End If
        End If
        ...
        Dim GarageFiltered() As Garage = getDeletedGaragesBySyncVersion(currentLastSyncVersion, whereStr)
    ...
    Private Sub lsvGarages_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles lsvGarage.MouseClick, lsvGarage.KeyDown, lsvGarage.KeyUp
        ...
        Dim theGarage As Garage = getDeletedGaragesBySyncVersion(currentLastSyncVersion, " AND idTable =" & lbIdGarageForm.Text)(0)
    ...
    Private Sub butAddToSync_Click(sender As Object, e As EventArgs) Handles butAddToSync.Click
        ...
        For Each item In lsvGarage.SelectedItems
            ...
            Dim newEntry As Boolean = Not syncGaragesToDelete.ContainsKey(idGarage)

            If newEntry Then
                Dim theGarage As Garage = getDeletedGaragesBySyncVersion(currentLastSyncVersion, " AND idTable =" & idGarage)(0)
                theGarage.actionType = "delete"
                syncGaragesToDelete.Add(idGarage, theGarage)
            End If
    ...
    Private Sub butRemoveFromSync_Click(sender As Object, e As EventArgs) Handles butRemoveFromSync.Click
        ...
        For Each item In lsvGarage.SelectedItems
            Dim idGarage As Integer = item.SubItems(0).Text
            syncGaragesToDelete.Remove(idGarage)
        Next
    ...
    Private Sub listSelectedGarage()
        lsvGarage.BackColor = System.Drawing.Color.FromArgb(255, 128, 128)
        If syncGaragesToDelete.Count > 0 Then
            Dim garagesSelected As Garage()
            Dim MyArray As New ArrayList(syncGaragesToDelete.Values)
