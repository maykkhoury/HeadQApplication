...
Public NotInheritable Class SplashScreen1
    ...
    Private Sub SplashScreen_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        'Format the version information using the text set into the Version control at design tim                               e as the
        ...
        Try
            Dim fileContents() As String = File.ReadAllLines(My.Application.Info.DirectoryPath & "//vers.txt", Encoding.UTF8)
